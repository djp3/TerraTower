...
public class TTEventHandlerBurnBombFuse extends TTEventHandler{    
	...
	public JSONObject checkParameters(long eventTime,TTEvent _event) {
		...
		//TTEventBurnBombFuse event = null;
		if(_event instanceof TTEventBurnBombFuse){
			//event = ((TTEventBurnBombFuse) _event);
		}
		else{
			ret.put("error","true");
	...
	public JSONObject onEvent() {
		...
		wm.burnBombFuse(this.eventTime);
		ret.put("error", "false");
		return ret;
	}
